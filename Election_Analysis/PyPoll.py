...
# Create an empty list for the Candidate Options
candidate_options = []
...
with open(file_to_load) as election_data:
    ...
    # Read the file object with the reader function  within the csv module
...
for candidate_name in candidate_votes:
    ...
    # Create the candidate_results variable
